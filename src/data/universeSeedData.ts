...
I love you more today than on the day we signed the paper.`,
  ...
  openWhenEnvelopes: [
    ...
    },
    {
      ...
      recipientRole: 'both',
      message: 'Close your eyes. Remember our very first drive along the coastline road with the windows down, cool Karachi sea breeze blowing, playing that Coke Studio track on repeat? We didn’t know how the future would unfold, but we knew we never wanted that car ride to end. That feeling is still alive right now.',
...
If you are reading this, two decades have passed since the night you stood before your families in Karachi and said yes to forever. 
  ...
  ourFirsts: [
    {
      ...
      subtitle: 'The Library Courtyard, Karachi',
      date: '14 October 2019',
      location: 'Clifton, Karachi',
      story: 'A rainy afternoon at the architectural archives. We both reached for the same vintage volume on coastal archways. One clumsy conversation, cardamom chai, and four hours passed like four minutes.',
    ...
    },
    {
      ...
      subtitle: 'A blurry Polaroid by the coast',
      date: '12 December 2019',
      location: 'Clifton Beach Promenade, Karachi',
  ...
  onePhotoTwoMemories: [
    {
      ...
      photoUrl: './images/hero.jpg',
      date: '20 September 2025',
      location: 'Coastal Rooftop Terrace, Karachi',
    ...
    },
    {
      ...
      herMemory: '“He looked so ridiculous trying to dance to that song with his cousins, but I had never seen him smile with so much pure abandon. I sat with my ammi watching him and whispered, ‘Look at my boy.’”',
  ...
  weddingDay24Hours: [
    {
      ...
      description: 'The morning sea breeze clears over Karachi. Both homes wake to quiet prayers, Quran recitation, and the sweet aroma of cardamom chai.',
      authorRole: 'family',
    },
    {
      id: 'wd-2',
...
Muzamil`,
  ...
  personalization: {
    howWeMet: 'At the historical architectural library archives in Old Clifton on a breezy Tuesday.',
    ...
    mostMeaningfulPlace: 'The coastal promenade overlooking the sunset across the Arabian Sea.',
