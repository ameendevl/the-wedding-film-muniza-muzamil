...
export const INITIAL_WEDDINGS: Record<string, WeddingData> = {
  'muniza-muzamil': {
    ...
    weddingDisplayDate: '25 December 2026',
    city: 'Karachi',
    country: 'Pakistan',
    ...
    letterText: [
      ...
      'From quiet conversations under Karachi’s evening skies to dreaming of the home we will build together, every memory has led us to this day. We gather not just to witness a union, but to honor the bonds of family, friendship, and eternal gratitude.',
    ...
    events: [
      {
        ...
        venueName: 'The Beach Luxury Courtyard',
        address: 'Beach Luxury Hotel, Lalazar, MT Khan Road, Karachi',
        dressCode: 'Traditional Vibrant Festive — Shades of Mustard, Emerald & Marigold',
        description: 'An intimate celebration under twinkling fairy lights by the waterfront with folk dholak songs, delicate henna, and fragrant night-blooming jasmine.',
        mapUrl: 'https://maps.google.com/?q=Beach+Luxury+Hotel+Karachi',
      ...
      },
      {
        ...
        venueName: 'Pearl Continental Grand Ballroom',
      ...
      },
      {
        ...
        time: '7:30 PM Dinner',
        venueName: 'Mövenpick Grand Banquets',
        address: 'Club Road, Civil Lines, Karachi',
    ...
    timeline: [
      {
        ...
        caption: 'A breezy afternoon at a quiet architectural library. A shared book on coastal heritage, a spilled cup of cardamom tea, and a conversation that never stopped.',
      ...
      },
      {
        ...
        caption: 'Between seaside sunsets, shared playlists, and quiet Sunday strolls, forever quietly stopped being a distant idea and started feeling real.',
        location: 'French Beach, Karachi',
        image: './images/proposal.jpg',
      },
      {
        year: '2025',
        title: 'One Question. One Answer.',
        caption: 'Under the warm amber glow of a coastal terrace at dusk, with the Arabian Sea in the distance, Muzamil asked the question that changed both our worlds.',
        location: 'Do Darya Pier, Karachi',
    ...
    dna: {
      ...
      whereWeMet: 'Karachi, Pakistan',
      proposalStory: 'A quiet sunset on a historic coastal terrace overlooking the Arabian Sea with a violin playing softly.',
...
export function getStoredWedding(slug: string): WeddingData {
  try {
    ...
    if (saved) {
      ...
      if (parsed[slug]) {
        if (slug === 'muniza-muzamil' && (parsed[slug].city !== 'Karachi' || parsed[slug].weddingDate !== '2026-12-25')) {
          parsed[slug] = INITIAL_WEDDINGS['muniza-muzamil'];
          saveStoredWedding(parsed[slug]);
        }
        return parsed[slug];
      }
    }
